...
CREATE INDEX idx_klines_us_ticker_date ON klines_us (k_ticker, k_date);
CREATE INDEX idx_klines_us_date ON klines_us (k_date);
CREATE INDEX idx_klines_us_ticker ON klines_us (k_ticker);
